...
import com.tugkgp.cn.util.ViewUtil;
...
public class TitleBar extends LinearLayout {
	...
	public void ininTitleBar(Context context){
		...
		titleTextLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.FILL_PARENT,1);
		...
		titleTextLayout.addView(titleTextBtn,new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
		
		titleSmallTextBtn = new Button(context);
		titleSmallTextBtn.setTextColor(Color.rgb(255, 255, 255));
		titleSmallTextBtn.setTextSize(12);
		...
		titleTextLayout.addView(titleSmallTextBtn,new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT));
